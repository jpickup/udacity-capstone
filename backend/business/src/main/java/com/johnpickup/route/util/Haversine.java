package com.johnpickup.route.util;
...
public class Haversine {
    ...
    public static double distanceDegrees(double rlat1, double rlong1, double rlat2, double rlong2) {
        return distance(Math.toRadians(rlat1), Math.toRadians(rlong1),
                Math.toRadians(rlat2), Math.toRadians(rlong2));
    }
