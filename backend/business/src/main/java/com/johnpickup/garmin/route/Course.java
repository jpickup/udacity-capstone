package com.johnpickup.garmin.route;
...
public class Course implements FitGenerator {
    ...
    private final List<com.johnpickup.garmin.route.CoursePoint> coursePoints;

    private Long timestamp;
    private static int instanceIndex = 0;

    public Course(String name, List<com.johnpickup.garmin.route.CoursePoint> coursePoints) {
        this.name = name;
    ...
    private List<Mesg> createCourse() {
        ...
        com.johnpickup.garmin.route.CoursePoint startPoint = coursePoints.get(0);
        com.johnpickup.garmin.route.CoursePoint endPoint = coursePoints.get(coursePoints.size()-1);
        ...
        com.johnpickup.garmin.route.CoursePoint prev = startPoint;
